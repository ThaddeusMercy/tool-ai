        ...
        {showMinting && (
          <div className="w-full md:w-[50rem] flex flex-col absolute top-[40%] md:top-[32%] bg-[#1FE2D6] md:left-[20%] z-50 shadow-lg border border-[#000A0F] rounded-xl p-4">
            ...
            <p className="text-[#00334B] text-[14px] font-semibold mt-4 mb-5">
              ...
              paradigm shift in the valuation and utilization of intellectual
              property. AiiP-NFTs, or Artificial Intelligence Intellectual
              Property Non-Fungible Tokens, empower users to transform their
              expertise and business strategies into securely tradable assets on
              the blockchain. By training AiTools (Ai Bots) to understand and
              execute specific business or marketing strategies, users can
              encapsulate the intellectual essence of their operations into
              tangible NFT form. This innovative approach allows individuals to
              collateralize their valuable knowledge and expertise, opening up
              new avenues for monetization and exchange. Moreover, the creation
              of a dedicated marketplace within the 2nd World ecosystem enables
              users to trade AiiP-NFTs seamlessly, thereby unlocking the true
              potential of artificial intelligence and intellectual property.
              With AiiP-NFTs, ToolAi not only revolutionizes the way
              intellectual property is valued but also fosters a vibrant economy
              where the knowledge and expertise of individuals are recognized
              and rewarded like never before.
            </p>
          </div>
        )}
      </div>
